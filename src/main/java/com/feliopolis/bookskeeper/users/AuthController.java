...
import com.feliopolis.bookskeeper.roles.RolesEnum;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        if (strRoles == null) {
            Role userRole = roleRepository.findByRole(RolesEnum.USER_ROLE)
            ...
            strRoles.forEach(role -> {
                ...
                switch (role) {
                    case "ADMIN_ROLE":
                        Role adminRole = roleRepository.findByRole(RolesEnum.ADMIN_ROLE)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(adminRole);
